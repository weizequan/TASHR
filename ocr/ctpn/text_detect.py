...
from ocr.ctpn.lib.utils.timer import Timer
from ocr.ctpn.lib.fast_rcnn.config import cfg
from ocr.ctpn.lib.fast_rcnn.test import  test_ctpn
from ocr.ctpn.lib.networks.factory import get_network
from ocr.ctpn.lib.text_connector.detectors import TextDetector
from ocr.ctpn.lib.text_connector.text_connect_cfg import Config as TextLineCfg
...
def load_tf_model():
    # load config file
    cfg.TEST.checkpoints_path = '/data/syhou/project/ip_trg/ocr/ctpn/checkpoints'
